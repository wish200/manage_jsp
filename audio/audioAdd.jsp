          ...
          <form id="audioForm" method="post">  
                ...
                <table class="school_task ostyle">
                  <tr>
                    ...
                    <th>发布时间：</th>
                    <td>
                      <input id="uploadtime" class="Wdate"   name="appAudioBaseDto.uploadtime" type="text" value="<fmt:formatDate value="${now}" pattern="yyyy-MM-dd HH:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
                       <span style="color:red">*</span>
                    </td>
                  </tr>
                  <tr>
                    <th>所属用户ID：</th>
                    <td>
		               <input id="userid" name="appAudioBaseDto.userid" type="text" onchange="changeuser(this)"/>
		               <span style="color:red">*</span>
                    </td>
                    <th>用户昵称：</th>
                    <td>
