          ...
          <form id="audioForm" method="post">  
                ...
                <table class="school_task ostyle">
                  <tr>
                    ...
                    <th>发布时间：</th>
                    <td>
                      <input id="uploadtime" class="Wdate"  name="appAudioBaseDto.uploadtime" type="text" value="${appAudioBaseDto.uploadtime } " onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                       <span style="color:red">*</span>
                    </td>
                  </tr>
                  <tr>
