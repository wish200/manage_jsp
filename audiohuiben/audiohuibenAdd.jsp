...
function keep(){
	...
	if(ok){ 
			  $("#audiohuibenForm").ajaxSubmit({
			          type : 'post',  
			          url : '${ctx}/audiohuiben/audiohuiben_add.do',  
			          ...
			          success: function(data){
			               ...
			               $('input[name="appAudioHuibenBaseDto.huibenid"]').val(data);
			               $('#cancleBtn').hide();
			               $('#keepBtn').hide();
			               $('#returnBtn').show();
			               $('#subBtn').show();
...
<div class="base_con">
          ...
          <form id="audiohuibenForm" method="post">  
                  <!--新生成的公告代码-->
				  <input id="huibenid" name="appAudioHuibenBaseDto.huibenid" value="" type="hidden" />  
                <table class="school_task ostyle">
                  <tr>
                    ...
                    <th>小红花数量：</th>
                    <td>
		               <input id="flowercnt" name="appAudioHuibenBaseDto.flowercnt" type="text"/>
		               <span style="color:red">*</span>
                    </td>
                  </tr> 
                  ...
                  <tr>
                  	<th>用户ID：</th>
                    <td>
		               <input id="userid" name="appAudioHuibenBaseDto.userid" type="text" onchange="changeuser(this)"/>
		               <span style="color:red">*</span>
                    </td>
                    <th>用户名称：</th>
                    <td>
		               <input id="nickname" name="appAudioHuibenBaseDto.nickname" type="text" /> 
                    </td>
                  </tr>
                  <tr>
                     <th>用户头像地址：</th>
                  ...
                  <tr>
                  	<th>绘画ID：</th>
                    <td>
		               <input id="picbookid" name="appAudioHuibenBaseDto.picbookid" type="text" onchange="changepicbook(this)"/>
		               <span style="color:red">*</span>
                    </td>
                    <th>绘画名称：</th>
                    <td>
		               <input id="picbookname" name="appAudioHuibenBaseDto.picbookname" type="text"/>
		               <span style="color:red">*</span>
                    </td>
                  </tr>
                  <tr>
                     <th>绘画场景：</th>
                     <td colspan="3">
                     <input id="picscene" type="text"  style="width:80%;"  readonly="readonly" name="appAudioHuibenBaseDto.picscene" />
                     </td>
                  </tr>
                  <tr>
                     <th>绘画图片地址：</th>
                     <td colspan="3">
                     <input id="picbookurl" type="text"  style="width:80%;"  readonly="readonly" name="appAudioHuibenBaseDto.picbookurl" />
                     </td>
                  </tr>
                  <tr>
                     <th>绘画图片：</th>
                     <td colspan="3">
	                    ...
	                    <img id="picbookimg" hspace='2' vspace='2' border='1' align='middle' height='100' width='100'  src="${ctx}${appAudioHuibenBaseDto.picbookurl }" onclick="selectForward(this)"  />
	                    </span>
                     </td>
                  </tr>
                  <tr>
                    <th>绘音编号：</th>
                    <td>
		               <input id="audioid" name="appAudioHuibenBaseDto.audioid" type="text" onchange="changeaudio(this)"/>
		               <span style="color:red">*</span>
                    </td>
                    <th>绘音名称：</th>
                    <td>
		               <input id="audioname" name="appAudioHuibenBaseDto.audioname" type="text"/>
		               <span style="color:red">*</span>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th>绘音地址：</th>
                     <td colspan="3">
	                    <input id="audiourl" type="text"  style="width:80%;"  readonly="readonly" name="appAudioHuibenBaseDto.audiourl" 
	                    onclick="selectForward1('${ctx}/jsp/program/play.jsp?name=${appAudioHuibenBaseDto.audiourl }&path=${appAudioHuibenBaseDto.audiourl }')"/>
                     </td>
                  </tr>
                  <tr class="height_70">
                    <th>绘音内容：</th>
                    <td colspan="3"><textarea style="height:300px;position:relative;float:left" id="audiocontent" name="appAudioHuibenBaseDto.audiocontent"></textarea>
                    </td>
                  </tr>
