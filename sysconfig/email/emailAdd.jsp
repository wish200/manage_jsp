...
//下拉菜单的选择级联与变化 JS 在templateCatno.js中
...
function returnc(){
	if(confirm("取消不保存本次操作")){
		asy_Ajax("${ctx}/sysconfig/emailTemplate_queryEmailTleForList.do",{},'html',function(data){
			 $("#content").html(data);
		});
	}
}
    ...
    var ok=haveData("templateName","模板名称不能为空！")&&
      ...
      if(ok){
	        $("#majorForm").ajaxSubmit({
			        type : 'post',  
			        url : '${ctx }/sysconfig/emailTemplate_insertEmailTle.do',  
          ...
          <form id="majorForm" method="post">   
                ...
                <table class="school_task ostyle">
                  <tr>
                    <th>模板名称：</th>
                    <td>
		               <input style="width:122px;" id="templateName" onblur="chickTemplateName();" name="cdEmailTemplateBaseDto.templatename" type="text" />
		               <span style="color:red">*</span>
                    </td>
                    <th>邮件主题：</th>
                    <td>
                       <input style="width:122px;" id="headoftempl" onkeyup="checkHeadoftempl();" name="cdEmailTemplateBaseDto.headoftempl" type="text" />
                       <span style="color:red">*</span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
		                ...
		                <div class="select select_1">
		                	<span id="suoShuGongNeng">请选择</span>
		                	<input name="cdEmailTemplateBaseDto.moduleid" style="display: none"  id="moduleid"/>
                    ...
                    <td>
		                ...
		                <div class="select select_1 selectClick1">
		                	<span  id="youJianLeiXing" >请选择</span>
		                	<input name="cdEmailTemplateBaseDto.templatecatno" style="display: none"  id="templatecatno"/>
                  ...
                  <!-- <tr>
                    ...
                    <td colspan="3">
					    ...
					    type="text" style="width:350px;"  readonly="readonly"/>
				         <input id="BCCid" type="hidden"  name="BCCCode"  value=""/>
				         <input id="Depid" type="hidden"   name="BCCDepCode"  value=""/>
                    </td>
                  </tr> -->
                </table>
                 <!-- 编辑器区域 -->
	             <textarea id="editor_id" name="cdEmailTemplateBaseDto.bodyoftempl" style="width:100%;height:300px;" ></textarea>
           </form>     
           ...
           <%--  <div>   
              <!-- 邮件模板表里面的数据 -->
			     <s:iterator value="cdEmailTemplateBaseDtoList" var="emailTemplatedto">
			          <input name="moBanCode" value="${emailTemplatedto.templatenum}"/>
			          <input name="moBanName"  value="${emailTemplatedto.templatename}"/>
			          <input name="moBan" value='${emailTemplatedto.bodyoftempl}'/>
			     </s:iterator>
            </div> --%>
