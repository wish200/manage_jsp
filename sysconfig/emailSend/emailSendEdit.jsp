...
<%--窗口关闭--%>
  ...
  <div class="title" style="">邮件内容<a href="javascript:closeDiv()" title="关闭" class="close"></a></div>
    <div class="con" style="width:520px;">
        ...
        <textarea id="editor_id" name="cdEmailTemplateBaseDto.bodyoftempl" style="width:103%;height:350px;display:none" ></textarea>
        </div>
         <div class="button_div" style="margin-top: ">
            <a class="return" href="javascript:closeDiv();">返　回</a>
            <a class="define" href="javascript:bodyQueDing();">确　定</a>
      </div>
    </div>
  </div>